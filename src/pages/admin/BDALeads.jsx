        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                ...
                <div>
                    <h1 className="text-gradient" style={{ fontSize: '28px', marginBottom: '4px' }}>
                        {bdaInfo ? `${bdaInfo.name}'s Leads` : 'Team Member Leads'}
                    </h1>
                    <p style={{ color: 'var(--text-muted)' }}>Detailed view of all leads and their current status</p>
                </div>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px' }}>
                <div className="glass-card" style={{ padding: '24px', display: 'flex', gap: '20px', alignItems: 'center' }}>
                    ...
                    <div>
                        <p style={{ fontSize: '14px', color: 'var(--text-muted)' }}>Total Leads Performance</p>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                    ...
                    <tbody>
                        <AnimatePresence>
                            {loading ? (
                                <tr>
                                    <td colSpan="4" style={{ textAlign: 'center', padding: '40px', color: 'var(--text-muted)' }}>Loading leads...</td>
                                </tr>
                            ) : leads.length === 0 ? (
                                <tr>
                                    <td colSpan="4" style={{ textAlign: 'center', padding: '40px', color: 'var(--text-muted)' }}>No leads found for this team member.</td>
                                </tr>
                            ) : leads.map((lead) => (
                                <motion.tr
                                    key={lead._id}
